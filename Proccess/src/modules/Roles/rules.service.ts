...
export default class RulesService {
  constructor(
    ...
    private readonly ruleModel: AggregatePaginateModel<RulesModel>,
    @InjectModel(AdaptationsModel.name)
    private readonly AdaptionModel: AggregatePaginateModel<AdaptationsModel>,
  ...
  async getRuleActionPerAgent(id: string) {
    await this.AdaptionModel.aggregate([
      {
        $match: {
          ruleId: id,
        },
